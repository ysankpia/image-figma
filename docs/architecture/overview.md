...
- Processing Pipeline：预处理、OCR、AI/CV、裁切、DSL Builder、校验和基础修复。
- Storage：原图、资产、DSL 结果、日志。
...
DSL 是唯一跨端合同。后端和 Renderer 的任何协议变化必须先更新 [dsl.md](dsl.md) 和 [api-contracts.md](api-contracts.md)。
