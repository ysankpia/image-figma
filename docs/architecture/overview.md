...
```text
services/pencil-python-backend as default product server
services/pencil-asset-backend as default asset server
services/pencil-handoff-studio as default handoff server
