...
- Remaining 189 work: payment provider query/reconciliation/refund/cancel, richer admin user/plan operations, production DB adapter beyond local SQLite, production object storage/signed access, legal/help pages, backup/restore/deploy runbooks, and final real-flow validation.
