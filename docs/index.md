...
- 当前 M30.5 image-internal overlay text promotion 计划：[plans/active/030-5-image-internal-overlay-text-promotion-and-parent-cleanup.md](plans/active/030-5-image-internal-overlay-text-promotion-and-parent-cleanup.md)
...
- M29.2 small overlay text miss audit 决策：[decisions/0058-audit-small-overlay-text-misses-before-supplemental-materialization.md](decisions/0058-audit-small-overlay-text-misses-before-supplemental-materialization.md)
- M29.3 image-internal overlay ownership 决策：[decisions/0059-bind-image-internal-overlays-before-materialization.md](decisions/0059-bind-image-internal-overlays-before-materialization.md)
- M29.4 image-internal overlay text recognition 决策：[decisions/0060-recognize-image-internal-overlay-text-before-promotion.md](decisions/0060-recognize-image-internal-overlay-text-before-promotion.md)
...
- M30.5 image-internal overlay text promotion 决策：[decisions/0061-promote-image-internal-overlay-text-after-parent-asset-cleanup.md](decisions/0061-promote-image-internal-overlay-text-after-parent-asset-cleanup.md)
