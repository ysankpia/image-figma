...
- 当前主线已由 M29 model-first 主链破坏性重构计划收口，见 [plans/completed/068-m29-model-first-mainline-destructive-refactor.md](plans/completed/068-m29-model-first-mainline-destructive-refactor.md)。该计划覆盖 065/066/067 的方向判断：默认 upload-preview 改为 model-first interactive 主链，旧 M29.6 -> transparent -> evidence -> promotion -> promoted rerun loop 不再是 active runtime。069 replay/asset contract hardening 见 [plans/completed/069-m29-replay-overlap-and-model-asset-contract-hardening.md](plans/completed/069-m29-replay-overlap-and-model-asset-contract-hardening.md)。被 068/069 覆盖的旧计划已归档到 [plans/archive/superseded/](plans/archive/superseded/index.md)，仅作历史背景，不能覆盖 068、当前代码地图和当前测试策略。刚完成的 media-contained control icon source-chain 计划见 [plans/completed/064-m29-media-contained-control-icon-source-chain-hardening.md](plans/completed/064-m29-media-contained-control-icon-source-chain-hardening.md)，M29 source-chain 修复计划见 [plans/completed/063-m29-source-chain-repair-and-anti-specialization-hardening.md](plans/completed/063-m29-source-chain-repair-and-anti-specialization-hardening.md)，Codia-like 真实样本加固计划见 [plans/completed/061-codia-like-real-sample-hardening.md](plans/completed/061-codia-like-real-sample-hardening.md)，image math 边界计划见 [plans/completed/059-image-math-dependencies-and-boundary-hardening.md](plans/completed/059-image-math-dependencies-and-boundary-hardening.md)。
