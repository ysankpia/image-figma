...
- 当前 M29 direct replay 分支实验计划：[plans/active/029-direct-replay-experiment.md](plans/active/029-direct-replay-experiment.md)
- 当前 M29 direct replay Figma 对比计划：[plans/active/029-direct-replay-figma-compare-mode.md](plans/active/029-direct-replay-figma-compare-mode.md)
- 当前 M29.2 source-level UI physical graph 计划：[plans/active/029-2-source-level-ui-physical-graph.md](plans/active/029-2-source-level-ui-physical-graph.md)
...
- 当前 M29.2.2 finite support and textured foreground ownership 计划：[plans/active/029-2-2-finite-support-and-textured-foreground-ownership.md](plans/active/029-2-2-finite-support-and-textured-foreground-ownership.md)
