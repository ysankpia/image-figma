...
- HTML-first UI Rebuilder standalone experiment: read [plans/completed/209-html-first-ui-rebuilder.md](plans/completed/209-html-first-ui-rebuilder.md) and [plans/completed/210-html-first-full-page-qwen-pass.md](plans/completed/210-html-first-full-page-qwen-pass.md), then use `tools/html-first-ui-rebuilder/`. This is not wired into Slice Studio.
- Go M29.0 standalone locator: read [plans/completed/212-go-m29-standalone-minimal-locator.md](plans/completed/212-go-m29-standalone-minimal-locator.md), then use `tools/go-m29-physical-evidence/`. It outputs `m29_locations.v1.json` plus `crops/loc_*.png`; it is not the default Slice Studio M29 provider.
- Python M29.0 standalone locator: read [plans/completed/213-py-m29-locator-parity.md](plans/completed/213-py-m29-locator-parity.md), then use `tools/py-m29-locator/`. It outputs the same coordinate JSON and crop package shape as the standalone Go locator; it is not wired into Slice Studio.
