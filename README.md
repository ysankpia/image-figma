...
5. 下一步基于 M29.1 grouping evidence 决定后续 OCR text mask 或 symbol vectorization；仍不要盲目做全局 icon detection、SVG/Figma replay 或直接 visible replay。
