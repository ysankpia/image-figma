...
export const xpayEnabled = normalizeBool(process.env.SLICE_STUDIO_XPAY_ENABLED, false);
export const xpayBaseUrl = trimTrailingSlash(process.env.SLICE_STUDIO_XPAY_BASE_URL || "");
export const xpayPid = process.env.SLICE_STUDIO_XPAY_PID || "";
export const xpayKey = process.env.SLICE_STUDIO_XPAY_KEY || "";
export const xpayNotifyUrl = process.env.SLICE_STUDIO_XPAY_NOTIFY_URL || "";
export const xpayReturnUrl = process.env.SLICE_STUDIO_XPAY_RETURN_URL || "";
export const freeProjectLimit = normalizeNumber(process.env.SLICE_STUDIO_FREE_PROJECT_LIMIT, 20);
export const paidProjectLimit = normalizeNumber(process.env.SLICE_STUDIO_PAID_PROJECT_LIMIT, 200);
export const maxPagesPerProject = normalizeNumber(process.env.SLICE_STUDIO_MAX_PAGES_PER_PROJECT, 100);
