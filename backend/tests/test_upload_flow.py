...
def test_legacy_upload_png_creates_completed_task_and_dsl(
    ...
    assert dsl["meta"]["qualityFlags"] == [
        ...
        "m23_icon_placement_plan",
        "m25_icon_business_candidates",
    ]
    ...
    assert dsl["meta"]["iconCandidateCount"] == 0
    assert dsl["meta"]["iconCroppedAssetCount"] == 0
    assert dsl["meta"]["iconBlockedCount"] == 0
    assert dsl["meta"]["iconFailedCropCount"] == 0
    assert dsl["meta"]["iconCoverageCandidateCount"] == 0
    assert dsl["meta"]["iconCoveragePlacementCount"] == 0
    assert dsl["meta"]["iconCoverageMissedHintCount"] == 0
    assert dsl["meta"]["iconPlacementReadyCount"] == 0
    ...
    assert dsl["meta"]["iconPlacementPlanCount"] == 0
    assert dsl["meta"]["iconPlacementReadyCount"] == 0
    assert dsl["meta"]["iconPlacementNeedsFallbackMaskCount"] == 0
    assert dsl["meta"]["iconPlacementNeedsSliceCoordinationCount"] == 0
    assert dsl["meta"]["iconPlacementNeedsFallbackCoordinationCount"] == 0
    assert dsl["meta"]["iconPlacementReviewRequiredCount"] == 0
    assert dsl["meta"]["iconPlacementBlockedCount"] == 0
    assert dsl["meta"]["iconPlacementDedupedCount"] == 0
    assert dsl["meta"]["iconBusinessCandidateCount"] == 0
    assert dsl["meta"]["iconBusinessCroppedAssetCount"] == 0
    assert dsl["meta"]["iconBusinessBlockedCount"] == 0
    assert dsl["meta"]["iconBusinessFailedCropCount"] == 0
