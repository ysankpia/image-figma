...
from .cleanup import (
    clean_internal_assets_from_copied_image_assets,
    clean_shape_backgrounds_from_copied_image_assets,
    clean_text_from_copied_image_assets,
    erase_replayed_bboxes_from_fallback,
)
...
def build_plan_driven_dsl(
    *,
    ...
    copied_image_asset_shape_erased_count = clean_shape_backgrounds_from_copied_image_assets(
        dsl,
        output_dir,
        replayed,
        plan_items=m295_plan_items,
    ...
    summary = build_summary(
        ...
        copied_image_asset_shape_erased_count=copied_image_asset_shape_erased_count,
        options=options,
